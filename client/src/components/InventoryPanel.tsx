    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="inventory-panel max-w-4xl w-full min-h-[40rem] max-h-[90vh] overflow-hidden
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 max-h-[calc(90vh-12rem)] overflow-y-auto">
          {/* Character Equipment */}
          <div className="equipment bg-[#3A2419] rounded-lg p-4 border-2 border-[#8B4513] 
                         shadow-[inset_0_0_10px_rgba(0,0,0,0.6)]">
            <h3 className="font-['VT323'] text-[#FFD700] text-center text-xl mb-4 border-b border-[#8B4513] pb-2">
              Equipment
            </h3>
                    ...
                    >
                      {equippedItem ? (
                        <div className="relative group">
                          ...
                          {/* Tooltip */}
                          <div className="tooltip-content invisible group-hover:visible absolute left-1/2 transform -translate-x-1/2 top-full mt-1 z-10
                        ...
                        <span className="text-[#614119] text-xs">{slot.label}</span>
                      )}
                    </div>
                  </div>
                );
          ...
          {/* Item List */}
          <div className="item-list bg-[#3A2419] rounded-lg p-4 border-2 border-[#8B4513] 
                         shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] flex flex-col">
            <h3 className="font-['VT323'] text-[#FFD700] text-center text-xl border-b border-[#8B4513] pb-2">
              Inventory
            </h3>
            
            <div className="tabs flex border-b border-[#8B4513] mt-2">
            ...
            <div className="items-grid grid grid-cols-4 gap-2 mt-3 flex-grow overflow-y-auto">
              {Object.values(groupedInventory).flat().map(item => (
                <div 
                  key={item.id}
                  className={`item-slot relative p-1 rounded border 
